...
export function getDeductionHintDetail(id: string, totalIncome: number): string {
  ...
  switch (id) {
    ...
    case "d30": return "เงินบริจาค 2 เท่า\n• การศึกษา, กีฬา, โรงพยาบาลรัฐ\n• ลดหย่อนได้ 2 เท่าของที่บริจาคจริง\n• ไม่เกิน 10% ของเงินได้หลังหักค่าใช้จ่าย";
    case "d31": return "เงินบริจาคทั่วไป 1 เท่า\n• องค์กรการกุศล/สาธารณประโยชน์\n• ไม่เกิน 10% ของเงินได้หลังหักค่าใช้จ่าย";
    case "d32": return "ช็อปดีมีคืน (Easy E-Receipt)\n• ใช้ใบกำกับภาษีอิเล็กทรอนิกส์\n• ไม่เกิน 50,000 บาท";
    case "d33": return "รายการลดหย่อนอื่นๆ ที่ไม่อยู่ในหมวดข้างต้น\n(กรอกได้ตามความเหมาะสม)";
    default:    return "";
  }
}
