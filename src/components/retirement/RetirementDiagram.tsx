  ...
  return (
    ...
    >
      ...
      <div className="flex items-center mb-2">
        <div
          className="text-[12px] text-[#c5cae9] font-bold text-center"
          style={{ width: `${BOX_W}px`, flexShrink: 0 }}
        >
          อายุปัจจุบัน
        </div>
        <div style={{ flex: workYears }} />
        <div
          className="text-[12px] text-[#1e3a5f] font-bold text-center"
          style={{ width: `${BOX_W}px`, flexShrink: 0 }}
        >
          อายุเกษียณ
        </div>
        <div style={{ flex: retireYears }} />
        <div
          className="text-[12px] text-gray-400 font-bold text-center"
          style={{ width: `${BOX_W}px`, flexShrink: 0 }}
        >
          อายุขัย
        </div>
      ...
      <div className="flex items-center mb-2">
        ...
        <div className="relative mx-0.5" style={{ flex: workYears }}>
          ...
          <div className="absolute -top-4 left-1/2 -translate-x-1/2 text-[13px] font-bold text-[#1e3a5f] bg-white px-1 whitespace-nowrap">
            {workYears} ปี
          </div>
        </div>
        <div
        ...
        <div className="relative mx-0.5" style={{ flex: retireYears }}>
          ...
          <div className="absolute -top-4 left-1/2 -translate-x-1/2 text-[13px] font-bold text-gray-500 bg-white px-1 whitespace-nowrap">
            {retireYears} ปี
          </div>
        </div>
        <div
              ...
              {tooltip &&
                (() => {
                  ...
                  return (
                    ...
                    >
                      <div className="font-bold text-[#1e3a5f] mb-1 text-[14px]">
                        {tooltip.title}
                      </div>
