      ...
      >
              ...
              {INCOME_TAX_CATEGORIES.map((c) => {
                ...
                return (
                  <button
                    ...
                    title={c.description}
                    className={`px-2 py-2 rounded-lg border text-[11px] font-semibold transition text-center ${
                      selected
        ...
        <Section title="ช่วงเดือน">
          ...
          <div className="mt-3 bg-white/50 rounded-lg p-2 border border-gray-200">
            <div className="text-[10px] text-gray-500 mb-1">ตัวอย่างหลังใช้</div>
            <div className="grid grid-cols-12 gap-0.5">
              {Array.from({ length: 12 }, (_, i) => {
                ...
                return (
                  <div
                    key={i}
                    className={`h-8 flex flex-col items-center justify-center rounded text-[9px] ${
                      inRange
                        ? isIncome
        ...
        {!isIncome && percentLinkType && (
          ...
          >
            ...
            {salaryPct != null && (
              <div className="text-[11px] text-indigo-600 mt-2">
