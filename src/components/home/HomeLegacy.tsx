...
/**
 * HomeLegacy — the original radial-dashboard Home page.
 *
 * Rendered when the FA's `skin` is `'legacy'` (the default for everyone
 * who signed up before migration 007). Pixel-identical to the previous
 * `src/app/page.tsx`; extracted so the new `page.tsx` can be a thin
 * router between Legacy and Professional skins.
 *
 * DO NOT add new features here. The Legacy skin is frozen so existing
 * users don't see unexpected UI changes. New work lives in HomePro.
 */
    ...
    <div className="min-h-dvh bg-[var(--color-bg)]">
      ...
      <div className="px-4 md:px-8 pt-8 md:pt-6 pb-4 md:pb-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/clients"
            className="flex flex-col items-center gap-0.5 p-2 rounded-xl hover:bg-gray-100 transition"
          >
