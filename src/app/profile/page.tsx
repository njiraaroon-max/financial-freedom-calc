...
export default function ProfilePage() {
  ...
  // Draft state — all edits go here first, only committed on save
  ...
  // Sync draft from store on first hydration
  useEffect(() => {
  ...
  const handleSave = () => {
    ...
    setHasSaved(true);
    setHasChanges(false);
    // Redirect to home after short delay to show saved state
    setTimeout(() => {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg)]">
      <PageHeader title="ข้อมูลส่วนตัว" subtitle="Personal Profile" />
        ...
        <ActionButton
          ...
          onClick={() => {
            if (confirm("ต้องการล้างข้อมูลทั้งหมดของลูกค้านี้ใช่ไหม?\n\nข้อมูลที่จะถูกล้าง:\n• ข้อมูลส่วนตัว\n• งบกระแสเงินสด\n• งบดุล\n• แผนเกษียณ\n• ตัวแปรที่บันทึกไว้\n\nข้อมูลจะกลับเป็นค่าเริ่มต้นทั้งหมด")) {
              const storeKeys = ["ffc-profile", "ffc-cashflow", "ffc-balance-sheet", "ffc-retirement", "ffc-variables"];
