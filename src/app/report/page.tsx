      ...
      <div className="max-w-5xl mx-auto bg-white print:max-w-full">
        ...
        <Page pageNum={1}>
          <div className="flex flex-col items-center justify-center min-h-[70vh] text-center px-6">
            ...
            <div className="mt-16 text-[13px] tracking-widest" style={{ color: MUTED }}>
        ...
        <Page pageNum={14} noBreakAfter>
          <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-6">
            ...
            <div className="mt-12 text-[13px] tracking-widest" style={{ color: MUTED }}>
              END OF REPORT · {today}
            </div>
            <div
...
function Page({
  ...
  return (
    ...
    >
      {children}
      <div
        className="absolute bottom-3 right-6 text-[13px] tracking-widest"
        style={{ color: MUTED }}
      >
        — {pageNum} —
      </div>
...
function PageHeader({ title, en }: { title: string; en: string }) {
  return (
    ...
    >
      ...
      <div
        className="text-[13px] tracking-[0.3em] px-3 py-1 rounded-full"
...
function SummaryBox({
  ...
  return (
    ...
    >
      <div
        className="text-[13px] tracking-widest mb-1"
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="text-[13px] tracking-widest opacity-70">{subtitle}</div>
      </div>
...
function Badge({ color, text }: { color: string; text: string }) {
  return (
    <span
      className="inline-block px-2 py-0.5 text-[14px] font-semibold rounded"
...
function PriorityTag({ priority }: { priority: "high" | "medium" | "low" }) {
  ...
  return (
    <span
      className="inline-block px-2 py-0.5 text-[14px] font-semibold rounded-full"
