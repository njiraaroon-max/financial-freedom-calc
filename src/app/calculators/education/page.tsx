      ...
      <div className="px-2 md:px-4 pt-3 pb-8 space-y-3">
        ...
        >
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 mb-4">
            <label className="text-[14px] font-bold text-amber-800 block mb-1">
                ...
                >
                  ...
                  {lv.enabled && (
                    <div className="space-y-2 ml-6">
                      <div className="flex items-center gap-2">
                        <label className="text-[13px] text-gray-600 w-28 shrink-0">ค่าเทอม/ปี:</label>
                        <MoneyInput
                        ...
                        />
                        <span className="text-[13px] text-gray-500 w-8">บาท</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <label className="text-[13px] text-gray-600 w-28 shrink-0">เรียนพิเศษ/ปี:</label>
                        <MoneyInput
                      ...
                      <div className="flex items-center gap-2">
                        <label className="text-[13px] text-gray-600 w-28 shrink-0">ชื่อโรงเรียน:</label>
                        <input
                          type="text"
                          value={lv.schoolName}
        ...
        {children.length > 0 && aggregated.rows.length > 0 && (
          ...
          >
            ...
            <div className="mt-5 pt-4 border-t border-gray-100">
                    ...
                    >
                      <div className="flex items-center justify-between mb-2.5">
                        ...
                        <div className="text-right">
                          <div className="text-[13px] text-gray-400 leading-none">รวม</div>
                          <div className="text-[16px] font-extrabold text-blue-600 leading-tight">
                            {fmtShort(childTotal)}
                          </div>
                        </div>
                      </div>
              ...
              {/* Legend */}
              <div className="mt-3 pt-3 border-t border-gray-100 flex flex-wrap gap-x-3 gap-y-1 text-[13px]">
                  ...
                  <div key={child.id} className="border border-gray-200 rounded-xl p-3 bg-indigo-50/30">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <button
                        ...
                        className="glass text-[13px] text-indigo-600 font-bold border border-indigo-300 rounded-lg px-2 py-1 hover:bg-indigo-100 flex items-center gap-1"
                      >
                    ...
                    {childPorts.length === 0 ? (
                      <div className="text-[13px] text-gray-400 italic text-center py-2">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div className="text-left">
            ...
            {subtitle && <div className="text-[13px] text-gray-400">{subtitle}</div>}
          </div>
        </div>
  ...
  return (
    <div className="p-4 bg-white space-y-3 border-t border-gray-100">
      ...
      <div className="grid grid-cols-2 gap-2">
        <div>
          <label className="text-[13px] text-gray-500 block mb-1">ชื่อเล่น</label>
          <input
            type="text"
            value={child.name}
        ...
        <div>
          <label className="text-[13px] text-gray-500 block mb-1">เพศ</label>
      ...
      {/* Birth year */}
      <div>
        <label className="text-[13px] text-gray-500 block mb-1">ปีเกิด (ค.ศ.)</label>
        <YearInput
      ...
      <div className="border-t border-gray-100 pt-3">
        ...
        {child.notEnrolled ? (
          <div className="space-y-2 bg-blue-50/50 border border-blue-200 rounded-xl p-3">
            <div className="grid grid-cols-2 gap-2">
              <div>
                <label className="text-[13px] text-gray-500 block mb-1">จะเข้าเรียนปี (ค.ศ.)</label>
                <YearInput
              ...
              <div>
                <label className="text-[13px] text-gray-500 block mb-1">เริ่มระดับชั้น</label>
                <select
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="text-[13px] text-gray-500 block mb-1">ระดับปัจจุบัน</label>
              <select
            ...
            <div>
              <label className="text-[13px] text-gray-500 block mb-1">ปีที่</label>
              <YearInLevelSelector
      ...
      <div className="grid grid-cols-2 gap-2">
        <div>
          <label className="text-[13px] text-gray-500 block mb-1">ป.ตรี (ปี)</label>
          <select
        ...
        <div>
          <label className="text-[13px] text-gray-500 block mb-1">ป.โท (ปี)</label>
          <select
...
function PortfolioEditor({
  ...
  return (
    <div className="glass rounded-xl p-3 space-y-3">
      ...
      <div>
        <label className="text-[13px] text-gray-500 block mb-1">ใช้เป็นทุนสำหรับระดับ</label>
          ...
          {LEVEL_SEQUENCE.map((k) => {
            ...
            return (
              <button
                ...
                className={`px-2 py-1 rounded-lg text-[13px] font-medium transition border ${
                  active
      ...
      <div className="grid grid-cols-3 gap-2">
        <div>
          <label className="text-[13px] text-gray-500 block mb-1">ลงทุน (ปี)</label>
          <YearInput
        ...
        <div>
          <label className="text-[13px] text-gray-500 block mb-1">ผลตอบแทน%</label>
          <DecimalInput
        ...
        <div>
          <label className="text-[13px] text-gray-500 block mb-1">ยอดมีอยู่</label>
          <MoneyInput
      ...
      >
        {calc.targetAmount === 0 ? (
          <div className="text-[13px] text-gray-500 text-center italic py-1">
            เลือกระดับที่ต้องการให้พอร์ตนี้ดูแลก่อน
          </div>
        ) : (
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              <span className="text-[13px] text-gray-600">เป้าหมายทุน</span>
              <span className="text-sm font-bold text-gray-800">{fmt(calc.targetAmount)}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-[13px] text-gray-600">ยอดมีอยู่ × ผลตอบแทน ({portfolio.yearsToInvest} ปี)</span>
            ...
            {calc.onTrack ? (
              ...
              <div className="border-t border-amber-200 pt-2 mt-2">
                <div className="flex items-center justify-between">
                  <span className="text-[13px] text-amber-700 font-bold">ต้องเก็บเพิ่ม/เดือน</span>
                  <span className="text-base font-extrabold text-amber-700">
                    {fmt(calc.monthlyContribution)} บาท
                  </span>
                </div>
                <div className="text-[13px] text-amber-600 text-right mt-0.5">
