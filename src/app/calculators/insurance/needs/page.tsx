  ...
  return (
    <div className="flex items-center gap-2">
      <div className="flex-1 min-w-0">
        ...
        {hint && <div className="text-[13px] text-gray-400">{hint}</div>}
      </div>
      ...
      <div className="glass relative w-full md:max-w-md rounded-t-3xl md:rounded-3xl max-h-[80vh] flex flex-col">
        ...
        <div className="overflow-y-auto flex-1 px-5 py-4 space-y-4">
          ...
          <div className="bg-emerald-50 rounded-xl p-3 border border-emerald-200">
            <div className="text-[13px] font-bold text-emerald-600 mb-1">สูตรคำนวณ</div>
            <div className="text-xs font-bold text-emerald-800">{guide.formula}</div>
          </div>

          {/* Explanation */}
          <div>
            <div className="text-[13px] font-bold text-gray-500 mb-1.5">คำอธิบาย</div>
          ...
          {guide.example && (
            <div className="bg-amber-50 rounded-xl p-3 border border-amber-200">
              <div className="text-[13px] font-bold text-amber-600 mb-1">ตัวอย่าง</div>
          ...
          <div className="bg-gray-50 rounded-xl p-3">
            <div className="text-[13px] font-bold text-gray-500 mb-1">อ้างอิงหลัก CFP</div>
            <div className="text-[14px] text-gray-600 italic">{guide.cfpRef}</div>
          </div>
        </div>
      </div>
    </div>
