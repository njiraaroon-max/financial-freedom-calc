...
const CALC_GUIDES: Record<string, CalcGuide> = {
  ...
  funeralCost: {
    title: "ค่าจัดการงานศพ",
    formula: "ค่าใช้จ่ายพิธีงานศพตามความเหมาะสม",
    explanation:
      "ค่าใช้จ่ายในการจัดงานศพ รวมค่าสถานที่ ค่าโลงศพ ค่าพิธีกรรมทางศาสนา ค่าอาหาร ฯลฯ ทั่วไปอยู่ที่ประมาณ 100,000 - 500,000 บาท ขึ้นอยู่กับรูปแบบงาน",
    example: "งานศพ 5 วัน ค่าวัด + ค่าเผา + ค่าอาหาร ≈ 200,000 บาท",
