...
function SectionHeader({ title, color }: { title: string; color: string }) {
  return (
    <tr>
      <td colSpan={6} className={`py-1.5 px-2 text-[14px] font-bold text-white ${color} rounded-lg`}>
        {title}
      </td>
    </tr>
  );
      ...
      <div className="px-4 md:px-8 pt-4 pb-8 space-y-4">
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="glass rounded-2xl p-3 text-center">
            <div className="text-[13px] text-gray-400">กรมธรรม์</div>
            <div className="text-lg font-extrabold text-gray-800">{policies.length}</div>
            <div className="text-[13px] text-gray-400">ฉบับ</div>
          </div>
          <div className="glass rounded-2xl p-3 text-center">
            <div className="text-[13px] text-gray-400">ความคุ้มครองพอ</div>
            <div className="text-lg font-extrabold text-emerald-600">{okCount}</div>
            <div className="text-[13px] text-gray-400">รายการ</div>
          </div>
          <div className="glass rounded-2xl p-3 text-center">
            <div className="text-[13px] text-gray-400">ยังขาด</div>
        ...
        <div className="glass rounded-2xl overflow-hidden">
          <div className="px-4 py-3 border-b border-gray-100">
            ...
            <p className="text-[13px] text-gray-400">เปรียบเทียบความคุ้มครองที่ควรมี vs ที่มีอยู่</p>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full min-w-[500px]">
              <thead>
                <tr className="bg-gray-50">
                  <th className="py-2 px-2 text-[13px] text-gray-500 text-left font-semibold">รายการ</th>
                  <th className="py-2 px-1 text-[13px] text-gray-500 text-right font-semibold">ควรมี</th>
                  <th className="py-2 px-1 text-[13px] text-gray-500 text-right font-semibold">สวัสดิการ</th>
                  <th className="py-2 px-1 text-[13px] text-gray-500 text-right font-semibold">ประกันเอง</th>
                  <th className="py-2 px-1 text-[13px] text-gray-500 text-right font-semibold">ส่วนต่าง</th>
