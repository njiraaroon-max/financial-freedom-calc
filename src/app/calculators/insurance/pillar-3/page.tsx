      ...
      <div className="px-2 md:px-4 pt-3 pb-8 space-y-3">
        ...
        <div className="glass rounded-2xl p-4 md:p-6 mx-1 space-y-4">
          <h3 className="text-sm font-bold text-gray-800 flex items-center gap-2">
            <span className="w-6 h-6 rounded-full bg-amber-500 text-white text-[13px] font-bold flex items-center justify-center">1</span>
          ...
          {p3.hasHome && (
            <>
              {/* Home type */}
              <div>
                <label className="text-[14px] text-gray-500 font-semibold block mb-2">ประเภทที่อยู่อาศัย</label>
        ...
        <div className="glass rounded-2xl p-4 md:p-6 mx-1 space-y-4">
          <h3 className="text-sm font-bold text-gray-800 flex items-center gap-2">
            <span className="w-6 h-6 rounded-full bg-amber-500 text-white text-[13px] font-bold flex items-center justify-center">2</span>
          ...
          {p3.hasVehicle && (
            <>
              ...
              <div>
                <label className="text-[14px] text-gray-500 font-semibold block mb-2">ประเภทประกันรถยนต์</label>
                  ...
                  {VEHICLE_TYPES.map((vt) => (
                    <button key={vt.value}
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[13px] text-gray-400">{vt.desc}</span>
                      </div>
                    </button>
                  ))}
                </div>
              ...
              {p3.vehicleInsuranceType === "none" && (
                <div className="bg-red-50 rounded-xl p-3 border border-red-200 text-[13px] text-red-700">
        ...
        <div className="glass rounded-2xl p-4 md:p-6 mx-1 space-y-4">
          <h3 className="text-sm font-bold text-gray-800 flex items-center gap-2">
            <span className="w-6 h-6 rounded-full bg-amber-500 text-white text-[13px] font-bold flex items-center justify-center">3</span>
          ...
          <div className="bg-orange-50 rounded-xl p-3 border border-orange-100 text-[13px] text-orange-700 leading-relaxed">
        ...
        <div className="glass rounded-2xl p-4 md:p-6 mx-1 space-y-4">
          <h3 className="text-sm font-bold text-gray-800 flex items-center gap-2">
            <span className="w-6 h-6 rounded-full bg-amber-500 text-white text-[13px] font-bold flex items-center justify-center">4</span>
          ...
          {p3.otherAssetValue > 0 && (
            <>
              ...
              />
              <div>
                <label className="text-[14px] text-gray-500 font-semibold block mb-1">รายละเอียด</label>
        ...
        <div className="glass rounded-2xl p-4 md:p-6 mx-1 space-y-4">
          <h3 className="text-sm font-bold text-gray-800 flex items-center gap-2">
            <span className="w-6 h-6 rounded-full bg-amber-500 text-white text-[13px] font-bold flex items-center justify-center">5</span>
          ...
          {analysis.items.length === 0 ? (
            ...
            <>
              ...
              <div className="border border-gray-100 rounded-xl overflow-hidden">
                <div className="grid grid-cols-4 gap-1 px-3 py-2 bg-gray-50 text-[13px] font-bold text-gray-500 uppercase">
                  <div>ทรัพย์สิน</div>
                ...
                {analysis.items.map((item) => {
                  ...
                  return (
                    <div key={item.label} className="grid grid-cols-4 gap-1 px-3 py-2.5 border-t border-gray-50 items-center">
                      <div className="text-[13px] text-gray-700 font-medium">{item.label}</div>
                      <div className="text-[13px] text-right font-bold text-gray-600">{fmtShort(item.need)}</div>
                      <div className="text-[13px] text-right font-bold text-amber-600">{fmtShort(item.have)}</div>
                      <div className={`text-[13px] text-right font-bold ${isOk ? "text-emerald-600" : "text-red-600"}`}>
        ...
        <div className="bg-amber-50 rounded-xl p-3 border border-amber-200 mx-1">
          <div className="text-[13px] font-bold text-amber-800 mb-1">💡 คำแนะนำจาก CFP</div>
          <div className="text-[13px] text-amber-700 leading-relaxed space-y-1">
