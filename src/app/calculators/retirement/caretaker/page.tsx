      ...
      <div className="px-4 md:px-8 py-5 pb-16 max-w-2xl mx-auto space-y-4">
        ...
        <div className="glass rounded-2xl p-4 space-y-3">
          ...
          <div className="space-y-1.5">
            <div className="text-[10px] text-gray-400">เลือกจาก preset:</div>
            ...
            <div className="flex items-center justify-between mb-1">
              <div className="flex items-center gap-1.5">
                ...
                {isLinked.postRetireReturn && (
                  <span className="text-[9px] px-1.5 py-0.5 rounded-full bg-blue-100 text-blue-700 font-medium">จากสมมติฐาน</span>
                )}
              </div>
...
function AgeRow({
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      />
      <span className="text-[10px] text-gray-400 w-6">{suffix}</span>
    </div>
  );
}
...
function Step({ n, title, children }: { n: number; title: string; children: React.ReactNode }) {
  return (
    <div className="flex gap-2">
      ...
      <div className="flex-1">
        <div className="font-bold text-gray-800 text-[11px]">{title}</div>
        <div className="bg-gray-50 rounded px-2 py-1 mt-0.5 text-[10px]">{children}</div>
      </div>
    </div>
  );
}
