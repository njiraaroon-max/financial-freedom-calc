    ...
    <div className="min-h-screen bg-[var(--color-bg)]">
      ...
      <div className="px-4 md:px-8 pt-4 pb-8">
        ...
        <div className="bg-gradient-to-br from-[#1e3a5f] to-[#3b6fa0] rounded-2xl p-4 text-white mx-1 mb-4 relative">
          ...
          <div className="pr-10">
            <div className="text-[13px] font-bold text-white/70 mb-1">Step 1 · Basic Expenses</div>
        ...
        <div className="flex items-center justify-between gap-2 px-1 mb-2">
          <div className="text-[14px] text-gray-500 flex items-center gap-1.5 leading-tight">
        ...
        <div className="glass rounded-2xl p-4">
          ...
          {store.showCfReference ? (
            <div className="grid grid-cols-[1fr_72px_96px_32px_28px] items-stretch text-[13px] font-bold text-gray-400 uppercase tracking-wide border-b border-gray-200">
            ...
            <div className="grid grid-cols-[1fr_104px_28px] items-stretch text-[13px] font-bold text-gray-400 uppercase tracking-wide border-b border-gray-200">
              <div className="px-2 py-1.5 border-r border-gray-100">รายการ</div>
        ...
        {totalBasicMonthly > 0 && (
          <div className="glass mt-4 rounded-2xl p-4">
              ...
              <svg width="280" height="200" viewBox="0 0 280 200">
                ...
                {(() => {
                  ...
                  return Array.from({ length: steps + 1 }, (_, i) => {
                    ...
                    return (
                      <g key={i}>
                        <text x="55" y={y + 3} textAnchor="end" className="text-[13px]" fill="#9ca3af">{fmt(Math.round(val))}</text>
                ...
                {(() => {
                  ...
                  return (
                    <>
                      ...
                      <text x="117" y={170 - h1 - 8} textAnchor="middle" className="text-[14px]" fontWeight="bold" fill="#374151">{fmt(totalBasicMonthly)}</text>
                      <text x="117" y="190" textAnchor="middle" className="text-[13px]" fill="#6b7280">ปัจจุบัน</text>

                      <rect x="175" y={170 - h2} width="55" height={h2} fill="#1e3a5f" rx="4" />
                      <text x="202" y={170 - h2 - 8} textAnchor="middle" className="text-[14px]" fontWeight="bold" fill="#1e3a5f">{fmt(Math.round(basicMonthlyFV))}</text>
                      <text x="202" y="190" textAnchor="middle" className="text-[13px]" fill="#6b7280">อนาคต</text>
                    </>
                  );
                })()}
              </svg>
            ...
            <div className="text-[13px] text-gray-400 text-center mt-2">
                ...
                {(() => {
                  ...
                  return (
                    <>
                      <div className="max-h-[360px] overflow-y-auto">
                        <table className="w-full text-xs">
                          <thead className="sticky top-0 bg-gray-50 border-b border-gray-200 z-10">
                            <tr>
                              <th className="px-3 py-2 text-left font-bold text-gray-500 text-[13px] uppercase tracking-wide">อายุ</th>
                              <th className="px-3 py-2 text-left font-bold text-gray-500 text-[13px] uppercase tracking-wide">พ.ศ.</th>
                              <th className="px-3 py-2 text-right font-bold text-gray-500 text-[13px] uppercase tracking-wide">/เดือน</th>
                              <th className="px-3 py-2 text-right font-bold text-gray-500 text-[13px] uppercase tracking-wide">/ปี</th>
                              <th className="px-3 py-2 text-right font-bold text-gray-500 text-[13px] uppercase tracking-wide">× PV</th>
                            </tr>
                          </thead>
                          <tbody>
                            {rows.map((r, i) => {
                              ...
                              return (
                                <tr key={r.age} className={rowClass}>
                                  <td className="px-3 py-1.5 font-bold text-[#1e3a5f] tabular-nums">
                                    {r.age}
                                    {isFirst && (
                                      <span className="ml-1 text-[13px] font-normal text-cyan-600">
                                        เกษียณ
                                      </span>
                                    )}
                                    {isLast && (
                                      <span className="ml-1 text-[13px] font-normal text-amber-600">
                                        สิ้นอายุขัย
                                      </span>
                                    )}
                                  </td>
                                  ...
                                  <td className="px-3 py-1.5 text-right tabular-nums text-gray-400 text-[13px]">
                          ...
                          <tfoot>
                            <tr className="bg-gray-100 font-bold border-t-2 border-gray-300">
                              <td colSpan={3} className="px-3 py-2 text-gray-700 text-[14px]">
                                รวม {rows.length} ปี (Nominal)
                              </td>
                              <td className="px-3 py-2 text-right tabular-nums text-red-700 text-[14px]">
                                ฿{fmt(totalNominal)}
                              </td>
                              <td></td>
                            </tr>
                      ...
                      <div className="px-3 py-2 bg-gray-50 text-[13px] text-gray-500 border-t border-gray-200 flex items-start gap-1.5">
                        <Info size={11} className="text-gray-400 shrink-0 mt-0.5" />
                        <div className="leading-relaxed">
                          สูตร: <code className="text-[13px] bg-white px-1 rounded">฿{fmt(totalBasicMonthly)} × 12 × (1 + {(a.generalInflation * 100).toFixed(1)}%)<sup>n</sup></code>
            ...
            {(() => {
              ...
              return (
                <div>
                          ...
                          {residuals.map((r, idx) => {
                            ...
                            return (
                              <th key={r} className={`text-center px-2 py-1.5 font-bold ${!isLast ? "border-r border-white/25" : ""} ${isCustom ? "bg-emerald-600/30" : ""}`}>
                                {isCustom && <div className="text-[12px] font-normal text-emerald-200">ตามแผนของคุณ</div>}
                                {r === 0 ? "0" : fmt(r)}
                              </th>
                            );
                          })}
                                  ...
                                  >
                                    {isSelected ? (
                                      <span className="inline-flex items-center justify-center gap-1.5">
                                        <span className="text-[#1e3a5f] text-[14px] leading-none">▶</span>
                  ...
                  <div className="px-3 py-2 text-[13px] text-gray-400 flex items-center justify-between gap-2 flex-wrap">
        ...
        >
          ...
          >
            ...
            <div className="px-5 py-4 space-y-5 text-gray-700">
              ...
              <div className="border border-gray-200 rounded-xl p-4 space-y-2">
                <div className="flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-blue-100 text-blue-700 text-[13px] font-bold flex items-center justify-center shrink-0">2</span>
              ...
              <div className="border-2 border-blue-400 rounded-xl p-4 space-y-2 bg-blue-50/30">
                ...
                <div className="text-[13px] text-blue-600 font-bold bg-blue-100 rounded-lg px-2 py-1 inline-block">หัวใจของการคำนวณ</div>
                <p className="text-[14px] leading-relaxed">
              ...
              <div className="border border-gray-200 rounded-xl p-4 space-y-2">
                <div className="flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-blue-100 text-blue-700 text-[13px] font-bold flex items-center justify-center shrink-0">4</span>
                ...
                <div className="bg-gray-50 rounded-lg px-3 py-2 text-[13px]">
              ...
              <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl p-4 border-2 border-cyan-300">
                ...
                <div className="glass rounded-lg px-3 py-2 text-[14px] space-y-1">
          ...
          >
            ...
            <div className="px-5 py-4 space-y-5 text-gray-700">
              ...
              <div className="bg-[#1e3a5f]/5 rounded-xl p-4 border-2 border-[#1e3a5f]/30 space-y-2">
                <div className="flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-[#1e3a5f] text-white text-[13px] font-bold flex items-center justify-center shrink-0">✓</span>
              ...
              <div className="space-y-3">
                <div className="border border-gray-200 rounded-xl p-4 space-y-2">
                  <div className="flex items-center gap-2">
                    <span className="w-6 h-6 rounded-full bg-blue-100 text-blue-700 text-[13px] font-bold flex items-center justify-center shrink-0">↕</span>
                  ...
                  <div className="bg-blue-50 rounded-lg px-3 py-2 text-[13px] space-y-0.5">
                ...
                <div className="border border-emerald-200 rounded-xl p-4 space-y-2 bg-emerald-50/30">
                  <div className="flex items-center gap-2">
                    <span className="w-6 h-6 rounded-full bg-emerald-500 text-white text-[13px] font-bold flex items-center justify-center shrink-0">✦</span>
              ...
              <div className="border-2 border-amber-400 rounded-xl p-4 space-y-2 bg-amber-50/30">
                <div className="flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-amber-500 text-white text-[13px] font-bold flex items-center justify-center shrink-0">⏳</span>
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-xl p-3 text-[14px] space-y-2">
              ...
              <div className="bg-teal-50 rounded-xl p-3 border border-teal-200">
                <div className="text-[13px] text-teal-700 leading-relaxed space-y-1">
            ...
            <div className="px-5 py-4 space-y-5 text-gray-700">
              ...
              <div className="border-2 border-blue-400 rounded-xl p-4 space-y-2 bg-blue-50/30">
                ...
                <div className="bg-blue-100 rounded-lg px-3 py-2 text-[13px] space-y-1">
                  ...
                  <div><code className="text-[13px]">n = ปีก่อนเกษียณ</code></div>
              ...
              <div className="border border-gray-200 rounded-xl p-4 space-y-2">
                ...
                <div className="bg-gray-50 rounded-lg px-3 py-2 text-[13px] space-y-1">
                  ...
                  <div><code className="text-[13px]">real_rate = (1+rate) ÷ (1+inflation) − 1</code></div>
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-xl p-3 text-[14px] space-y-1.5">
                  <div className="flex items-center gap-2">
