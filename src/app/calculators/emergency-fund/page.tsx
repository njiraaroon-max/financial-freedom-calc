      ...
      <div className="min-h-screen bg-[var(--color-bg)]">
        ...
        <div className="px-4 md:px-8 py-12 text-center">
          ...
          <div className="space-y-3 max-w-xs mx-auto text-left">
            <div>
              <label className="text-[14px] text-gray-500 mb-1 block">รายจ่ายจำเป็น/เดือน</label>
              <MoneyInput
                value={manualExpense}
            ...
            <div>
              <label className="text-[14px] text-gray-500 mb-1 block">สินทรัพย์สภาพคล่องปัจจุบัน</label>
              <MoneyInput
                value={manualLiquid}
        ...
        <div className={`rounded-2xl overflow-hidden ${isEnough ? "bg-gradient-to-br from-emerald-500 to-teal-700" : "bg-gradient-to-br from-red-500 to-rose-700"}`}>
          ...
          <div className="grid grid-cols-2 gap-0.5 px-3">
            <div className="bg-white/10 rounded-xl p-4 text-white text-center">
              <div className="text-[13px] opacity-70 mb-1">เงินสำรองที่ต้องมี</div>
              <div className="text-xl font-extrabold">฿{fmt(targetAmount)}</div>
              <div className="text-[13px] opacity-50 mt-1">{fmt(effectiveExpense)} × {targetMonths} เดือน</div>
            </div>
            <div className="bg-white/10 rounded-xl p-4 text-white text-center">
              <div className="text-[13px] opacity-70 mb-1">เงินสำรองที่มี</div>
              <div className="text-xl font-extrabold">฿{fmt(effectiveLiquid)}</div>
              <div className="text-[13px] opacity-50 mt-1">สินทรัพย์สภาพคล่อง</div>
            </div>
          </div>
          ...
          <div className="px-5 pt-4 pb-2">
            <div className="flex justify-between items-center mb-1.5">
              <span className="text-[14px] text-white/70 font-medium">ความคืบหน้า</span>
          ...
          <div className="px-5 pb-5 pt-2">
            <div className="bg-white/20 backdrop-blur rounded-xl p-4 text-center">
              {isEnough ? (
                <>
                  <div className="text-[14px] text-white/70">เกินมา</div>
                  <div className="text-2xl font-extrabold text-white">+฿{fmt(surplus)}</div>
                </>
              ) : (
                <>
                  <div className="text-[14px] text-white/70">ขาดอีก</div>
        ...
        <div className="px-4 md:px-8 pt-4">
          <div className="glass rounded-2xl p-4">
            ...
            <div className="bg-indigo-50 rounded-xl p-3 text-center">
              <div className="text-[13px] text-indigo-500 mb-1">จะมีเงินสำรองครบใน</div>
              <div className="text-2xl font-bold text-indigo-700">{monthsToGoal} เดือน</div>
              <div className="text-[13px] text-indigo-400">
