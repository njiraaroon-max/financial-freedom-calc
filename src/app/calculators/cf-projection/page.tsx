          ...
          >
            ...
            {insights.milestones.length > 0 && (
              <div className="border-t border-white/60 pt-3 mt-3">
                <div className="text-[13px] font-bold text-gray-600 mb-2 uppercase tracking-wider">
                  📍 หลักไมล์สำคัญ
                </div>
        ...
        {rows.length > 0 && (
          <div className="glass rounded-2xl p-4 mx-1">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-[13px] text-gray-400">ค.ศ. {rows[0].year} → {rows[rows.length - 1].year}</span>
            </div>
            ...
            return (
              ...
              >
                ...
                <td className="py-1.5 px-2 text-gray-700">
                  {r.age}
                  {isRetireYear && <span className="text-[13px] text-amber-600 ml-1">★</span>}
                </td>
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <div>
                  ...
                  <div className="text-[13px] text-gray-400">ปี {r.year} / พ.ศ. {r.yearBE}</div>
                </div>
                <div className={`text-right ${r.endingBalance > 0 ? "text-sky-700" : "text-red-700"}`}>
                  <div className="text-[13px] text-gray-400">คงเหลือ</div>
...
function SpreadsheetView({
  ...
  return (
    <div className="glass rounded-2xl mx-1 overflow-hidden">
      {/* Legend */}
      <div className="px-3 py-2 border-b border-gray-100 bg-gray-50 flex flex-wrap gap-2 text-[13px]">
              ...
              return (
                ...
                >
                  <td className={`py-1.5 px-2 sticky left-0 z-[5] font-medium ${healthBg[h] || "bg-white"}`}>
                    ...
                    <div className="text-[13px] text-gray-400">พ.ศ. {r.yearBE}</div>
                  </td>
                  <td className="py-1.5 px-1 text-center font-bold text-gray-700">
                    {r.age}
                    {isRetireYear && <div className="text-[12px] text-amber-600">★</div>}
                  </td>
      ...
      {/* Footer explanation */}
      <div className="px-3 py-2.5 border-t border-gray-100 bg-gray-50 text-[13px] text-gray-500 leading-relaxed">
